...
import MessageHistoryPanel from "@/features/messages/MessageHistoryPanel";
...
export default async function Page({params}: {params: Promise<{lang: string}>}) { const {lang} = await params; const locale = lang as Locale; const user = await requireAuthenticatedUser(locale); return <AccountWorkspaceShell active="bookings" locale={locale} user={user}><><AccountBookingsPanel locale={locale} /><MessageHistoryPanel /></></AccountWorkspaceShell>; }
