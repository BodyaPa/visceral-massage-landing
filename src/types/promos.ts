...
export type PromoUsage = {id:number;userId:number;bookingId:number|null;eventEnrollmentId:number|null;discountPercent:number;originalPrice:number;discountAmount:number;finalPrice:number;usedAt:string};
