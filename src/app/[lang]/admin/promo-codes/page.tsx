...
export default async function Page({params}:{params:Promise<{lang:string}>}){const {lang}=await params;await requireRole("ADMIN",lang as Locale);return <PromoCodesManagement/>}
